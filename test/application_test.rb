...
require File.join('../app/application')
require 'test/unit'

# This test makes sure the name of the item is the one expected
class TestSecretHandshake < Test::Unit::TestCase
  ...
  def test_handshake_11111_to_jump_close_your_eyes_double_blink_and_wink
    # skip
